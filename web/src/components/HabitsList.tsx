...
export function HabitsList({ date, onCompletedChanged }: HabitsListProps){
    ...
    async function handleToggleHabit(habitId: string){
        const isHabitAlreadyCompleted = habitsInfo!.completedHabits.includes(habitId); // boolean
        ...
        setHabitsInfo({
            possibleHabits: habitsInfo!.possibleHabits, // essa informação tem que existir,garanto isso com o !
            completedHabits,
        })
